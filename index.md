...
- Enable compiler code coverage instrumentation and generate `.html` code coverage reports (for some build types).
   - Building with coverage instrumentation is [supported (and enabled automatically) for CMake debug builds with either Clang or GCC compilers](https://github.com/219-design/qt-qml-project-template-with-ci/blob/35e57e2b4565d4d15573aeab794d00dde4e2d467/cmake_include/code_coverage_settings.cmake).
   ...
   - `process_coverage_data.sh` [generates `.html` code coverage reports for those supported build types](https://github.com/219-design/qt-qml-project-template-with-ci/blob/35e57e2b4565d4d15573aeab794d00dde4e2d467/tools/auto_test/process_coverage_data.sh).
